...
export const PlaceCard: React.FC<PlaceCardProps> = ({ place, userLocation, currentUser, onSelect, onEdit }) => {
  ...
  const isAuthor = canEditPlace(place, currentUser ?? null);
          ...
          <div className="flex items-center gap-1.5">
            {onEdit && isAuthor && (
              <button
                ...
                className="px-2.5 py-1.5 rounded-xl bg-orange-100 dark:bg-orange-950/80 text-orange-700 dark:text-orange-300 hover:bg-orange-600 hover:text-white dark:hover:bg-orange-600 dark:hover:text-white transition flex items-center gap-1.5 text-xs font-bold border border-orange-200 dark:border-orange-800 shadow-xs active:scale-95"
            ...
            <a
              ...
              className="px-2.5 py-1.5 rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700 transition flex items-center gap-1 text-xs font-bold border border-gray-200 dark:border-gray-700 shadow-xs"
